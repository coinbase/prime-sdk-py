...
def main():
    ...
    address = OnchainAddress(name=args.address_name, address=args.address, chain_ids=chain_ids)
    ...
    request = CreateOnchainAddressBookEntryRequest(portfolio_id=portfolio_id, address_group=address_group)
