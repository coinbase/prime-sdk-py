...
from prime_sdk.services.transactions import CreateOnchainTransactionRequest, Rpc, EvmParams
...
def main():
    ...
    parser.add_argument("--raw-unsigned-txn", required=True, help="Raw unsigned transaction (hex encoded)")
