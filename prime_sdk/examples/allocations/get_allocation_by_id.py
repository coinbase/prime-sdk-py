...
def main():
    ...
    parser.add_argument(
        "--allocation-id", dest="allocation_id_named", help="Allocation ID"
    )
    ...
    if not allocation_id:
        print(
            "Error: Allocation ID must be provided as positional argument or --allocation-id"
        )
        return
    ...
    request = GetAllocationByIdRequest(
        portfolio_id=portfolio_id, allocation_id=allocation_id
    )
