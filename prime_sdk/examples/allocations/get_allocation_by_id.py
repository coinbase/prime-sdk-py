...
def main():
    ...
    parser.add_argument("allocation_id", nargs="?", help="Allocation ID")
    parser.add_argument("--portfolio-id", help="Portfolio ID (overrides PRIME_PORTFOLIO_ID env var)")
    parser.add_argument("--allocation-id", dest="allocation_id_named", help="Allocation ID")
    ...
    request = GetAllocationByIdRequest(portfolio_id=portfolio_id, allocation_id=allocation_id)
