...
def main():
    ...
    if not netting_id:
        print("Error: Netting ID must be provided as positional argument or --netting-id")
        return

    # Initialize the client
    client = PrimeServicesClient.from_env()

    request = GetNetAllocationsByNettingIdRequest(portfolio_id=portfolio_id, netting_id=netting_id)
