...
def main():
    parser = argparse.ArgumentParser(description="Get address book entries")
    parser.add_argument("--portfolio-id", help="Portfolio ID (overrides PRIME_PORTFOLIO_ID env var)")
    parser.add_argument("--currency-symbol", help="Filter by currency symbol (e.g., BTC, ETH)")
    parser.add_argument("--search", help="Search term to filter entries")
