...
def main():
    ...
    parser.add_argument("--activity-level", choices=[level.value for level in ActivityLevel], 
    ...
    if args.end_time:
        try:
            ...
            print(f"Error: Invalid end-time format. Use ISO format like '2025-01-01T00:00:00'")
            return
