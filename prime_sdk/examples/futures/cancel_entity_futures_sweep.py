...
from prime_sdk.services.futures import CancelEntityFuturesSweepRequest
...
def main():
    ...
    request = CancelEntityFuturesSweepRequest(entity_id=entity_id)

    try:
        response = client.futures.cancel_entity_futures_sweep(request)
        print(response)
    except Exception as e:
        print(f"failed to cancel entity futures sweep: {e}")
