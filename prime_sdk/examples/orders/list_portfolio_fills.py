...
def main():
    ...
    parser.add_argument(
        "--start-date",
        required=True,
        help="Start date (ISO format: 2025-01-01T00:00:00, timezone Z will be added automatically)",
    )
    parser.add_argument(
        "--end-date",
        help="End date (ISO format: 2025-01-01T23:59:59, timezone Z will be added automatically)",
    )
