...
# #docs operationId: PrimeRESTAPI_CreateOrderPreview
# #docs operationName: Create Order Preview
...
def main():
    parser = argparse.ArgumentParser(
        description="Create an order preview to estimate costs and execution details"
    )
    parser.add_argument(
