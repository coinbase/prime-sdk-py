...
def main():
    ...
    parser.add_argument(
        "--states", help="Invoice states filter (e.g., DRAFT,SENT,PAID)"
    )
    parser.add_argument(
        "--billing-year", type=int, help="Billing year filter (e.g., 2025)"
    )
    parser.add_argument(
        "--billing-month", help="Billing month filter (e.g., JANUARY, FEBRUARY)"
    )
