...
def main():
    parser = argparse.ArgumentParser(description="List aggregate positions for an entity")
    ...
    request = ListAggregateEntityPositionsRequest(entity_id=entity_id, pagination=pagination)
