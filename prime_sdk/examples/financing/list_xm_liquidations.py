...
from prime_sdk.services.financing import ListXMLiquidationsRequest
...
def main():
    ...
    try:
        response = client.financing.list_xm_liquidations(request)
        print(response)
    except Exception as e:
        print(f"failed to list XM liquidations: {e}")
