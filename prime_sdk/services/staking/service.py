...
class StakingService:
    ...
    def create_portfolio_stake(
        self, request: CreatePortfolioStakeRequest
    ) -> CreatePortfolioStakeResponse:
    ...
    def create_portfolio_unstake(
        self, request: CreatePortfolioUnstakeRequest
    ) -> CreatePortfolioUnstakeResponse:
    ...
    def claim_wallet_staking_rewards(
        self, request: ClaimWalletStakingRewardsRequest
    ) -> ClaimWalletStakingRewardsResponse:
    ...
    def query_transaction_validators(
        self, request: QueryTransactionValidatorsRequest
    ) -> QueryTransactionValidatorsResponse:
        path = (
            f"/portfolios/{request.portfolio_id}/staking/transaction-validators/query"
        )
        body = to_body_dict(request)
        response = self.client.request(
            "POST", path, body=body, allowed_status_codes=request.allowed_status_codes
    ...
    def get_unstaking_status(
        self, request: GetUnstakingStatusRequest
    ...
    def get_staking_status(
        self, request: GetStakingStatusRequest
