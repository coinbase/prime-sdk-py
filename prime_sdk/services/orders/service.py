...
class OrdersService:
    ...
    def cancel_order(self, request: CancelOrderRequest) -> CancelOrderResponse:
        ...
        response = self.client.request(
            "POST", path, allowed_status_codes=request.allowed_status_codes
        )
    ...
    def create_order_preview(
        self, request: CreateOrderPreviewRequest
    ...
    def edit_order(self, request: EditOrderRequest) -> EditOrderResponse:
        ...
        body = to_body_dict(request)
        response = self.client.request(
            "PUT", path, body=body, allowed_status_codes=request.allowed_status_codes
        )
    ...
    def get_order_edit_history(
        self, request: GetOrderEditHistoryRequest
    ) -> GetOrderEditHistoryResponse:
        path = (
            f"/portfolios/{request.portfolio_id}/orders/{request.order_id}/edit_history"
        )
        response = self.client.request(
            "GET", path, allowed_status_codes=request.allowed_status_codes
        )
    ...
    def list_open_orders(
        self, request: ListOpenOrdersRequest
        ...
        query_params = append_query_param(
            query_params, "order_type", request.order_type
        )
        query_params = append_query_param(
            query_params, "order_side", request.order_side
        )

        if request.start_date:
            query_params = append_query_param(
                query_params, "start_date", request.start_date.isoformat() + "Z"
            )
        if request.end_date:
            query_params = append_query_param(
    ...
    def list_order_fills(
        self, request: ListOrderFillsRequest
    ...
    def list_orders(self, request: ListOrdersRequest) -> ListOrdersResponse:
        ...
        query_params = append_query_param(
            query_params, "product_ids", request.product_ids
        )
        query_params = append_query_param(
            query_params, "order_type", request.order_type
        )
    ...
    def list_portfolio_fills(
        self, request: ListPortfolioFillsRequest
        ...
        if request.end_date:
            query_params = append_query_param(
                query_params, "end_date", request.end_date
            )
