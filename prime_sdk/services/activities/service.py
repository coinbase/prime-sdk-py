...
class ActivitiesService:
    ...
    def get_entity_activity(
        self, request: GetEntityActivityRequest
    ...
    def list_activities(self, request: ListActivitiesRequest) -> ListActivitiesResponse:
        ...
        query_params = append_query_param(
            query_params, "categories", request.categories
        )
        query_params = append_query_param(query_params, "statuses", request.statuses)

        if request.start_time:
            query_params = append_query_param(
                query_params, "start_time", request.start_time.isoformat() + "Z"
            )
        if request.end_time:
            query_params = append_query_param(
                query_params, "end_time", request.end_time.isoformat() + "Z"
            )
    ...
    def list_entity_activities(
        self, request: ListEntityActivitiesRequest
    ) -> ListEntityActivitiesResponse:
