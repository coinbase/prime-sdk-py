...
class AllocationsService:
    ...
    def create_portfolio_allocations(
        self, request: CreatePortfolioAllocationsRequest
    ) -> CreatePortfolioAllocationsResponse:
        path = "/allocations"
    ...
    def create_portfolio_net_allocations(
        self, request: CreatePortfolioNetAllocationsRequest
    ) -> CreatePortfolioNetAllocationsResponse:
    ...
    def get_allocation_by_id(
        self, request: GetAllocationByIdRequest
    ...
    def get_net_allocations_by_netting_id(
        self, request: GetNetAllocationsByNettingIdRequest
    ) -> GetNetAllocationsByNettingIdResponse:
        path = (
            f"/portfolios/{request.portfolio_id}/allocations/net/{request.netting_id}"
        )
        response = self.client.request(
            "GET", path, allowed_status_codes=request.allowed_status_codes
        )
    ...
    def list_portfolio_allocations(
        self, request: ListPortfolioAllocationsRequest
    ) -> ListPortfolioAllocationsResponse:
