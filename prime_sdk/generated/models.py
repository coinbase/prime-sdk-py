...
# Inline request models from OpenAPI paths
...
@dataclass(kw_only=True)
class CancelFuturesSweepRequest:
    """
...
@dataclass(kw_only=True)
class GetAllocationsByClientNettingIdRequest:
    """
...
@dataclass(kw_only=True)
class GetEntityActivitiesRequest:
    """
    ...
    Attributes:
        ...
        cursor: Id to retrieve additional results strictly after
...
@dataclass(kw_only=True)
class GetEntityPaymentMethodDetailsRequest:
    """
...
@dataclass(kw_only=True)
class GetEntityPaymentMethodsRequest:
    """
...
@dataclass(kw_only=True)
class GetEntityUsersRequest:
    """
    List Users

    Attributes:
        entity_id: The entity ID
        cursor: Cursor used for pagination (last consumed record)
        limit: Number of items to retrieve
        sort_direction: Sorting order
    """
...
@dataclass(kw_only=True)
class GetExistingLocatesRequest:
    """
...
@dataclass(kw_only=True)
class GetInterestAccrualsRequest:
    """
...
@dataclass(kw_only=True)
class GetLocateAvailabilitiesRequest:
    """
...
@dataclass(kw_only=True)
class GetMarginConversionsRequest:
    """
...
@dataclass(kw_only=True)
class GetMarginSummariesRequest:
    """
...
class GetOpenOrdersRequest:
    ...
    Attributes:
        ...
        cursor: **Deprecated** - this endpoint always returns one page with at most 1000
            orders. If you need to retrieve more than 1000 orders, use the WebSocket API
            instead.
        limit: **Deprecated** - the limit for this endpoint is always 1000. If you need to
            retrieve more than 1000 orders, use the WebSocket API instead.
        sort_direction: Sorting order
...
@dataclass(kw_only=True)
class GetPortfolioActivitiesRequest:
    """
    List Activities
...
@dataclass(kw_only=True)
class GetPortfolioActivityRequest:
    """
...
@dataclass(kw_only=True)
class GetPortfolioAddressBookRequest:
    """
    Get Address Book
    ...
    Attributes:
        ...
        cursor: ID marking the point after which additional results should be retrieved
...
@dataclass(kw_only=True)
class GetPortfolioAllocationsRequest:
    """
    ...
    Attributes:
        ...
        cursor: Id to retrieve additional results strictly after
        limit: Number of items to retrieve
        sort_direction: Sorting order: DESC or ASC
    """


@dataclass(kw_only=True)
class GetPortfolioBalancesRequest:
    """
...
@dataclass(kw_only=True)
class GetPortfolioCounterpartyIDRequest:
    """
...
@dataclass(kw_only=True)
class GetPortfolioFillsRequest:
    """
...
@dataclass(kw_only=True)
class GetPortfolioInterestAccrualsRequest:
    """
...
@dataclass(kw_only=True)
class GetPortfolioProductsRequest:
    """
    ...
    Attributes:
        portfolio_id: The portfolio ID
        cursor: Cursor used for pagination (last consumed record)
        limit: Number of items to retrieve. Must be between 0 (defaulted to 10) and 1000.
        sort_direction: Sorting order
...
@dataclass(kw_only=True)
class GetPortfolioTransactionsRequest:
    """
    ...
    Attributes:
        ...
        cursor: Id to retrieve additional results strictly after.
        limit: Number of items to retrieve
        sort_direction: Page sorting direction
...
@dataclass(kw_only=True)
class GetPortfolioUsersRequest:
    """
...
@dataclass(kw_only=True)
class GetPostTradeCreditRequest:
    """
...
@dataclass(kw_only=True)
class GetTFTieredPricingFeesRequest:
    """
...
class GetWalletDepositInstructionsRequest:
    ...
    Attributes:
        ...
        deposit_type: The deposit type - UNKNOWN_WALLET_DEPOSIT_TYPE: nil value - CRYPTO: A
            ...
            Euro Payments Area)
        network.id: The name of the network The network id: base, bitcoin, ethereum, solana
            etc
        network.type: The network type The network type: mainnet, testnet, etc
    """
...
@dataclass(kw_only=True)
class GetWithdrawalPowerRequest:
    """
...
class ListAdvancedTransfersRequest:
    ...
    Attributes:
        ...
        limit: The maximum number of Advanced Transfers to return
        sort_direction: Page sorting direction
...
@dataclass(kw_only=True)
class ListTFObligationsRequest:
    """
...
class ListWalletAddressesRequest:
    ...
    Attributes:
        ...
        cursor: Cursor to retrieve the next page of results
        limit: Maximum number of addresses to return in a single response
    """
...
class ListWeb3WalletBalancesRequest:
    ...
    Attributes:
        ...
        cursor: Id to retrieve additional results strictly after
        limit: Number of items to retrieve. Defaults to 100 with a max size of 500.
    """
